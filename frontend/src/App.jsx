                           ...
                           <div key={restaurant.id} className="restaurant-card">
                               ...
                               <div className="recommendation-reason">
                                   ...
                                   <ul className="reason-list">
                                       {user_context.preferences.cuisine_preferences?.includes(restaurant.cuisine) && 
                                           <li>Matches your cuisine preference for {restaurant.cuisine}</li>
                                       }
                                       {user_context.preferences.budget === restaurant.price_range && 
                                       ...
                                       {/* If no specific reasons, show generic one */}
                                       {!(user_context.preferences.cuisine_preferences?.includes(restaurant.cuisine) || 
                                          user_context.preferences.budget === restaurant.price_range) &&
...
// Add new MCPDashboard component
const MCPDashboard = () => {
  return (
